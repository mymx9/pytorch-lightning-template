...
class ChestXRayMulticlassDataset(Dataset):
    """Chest X-Ray multiclass classification dataset (3 classes).
    ...
    Dataset structure:
        train/
            NORMAL/
                *.jpeg
            PNEUMONIA/
                person{patient_id}_bacteria_{index}.jpeg  # Bacterial pneumonia
                person{patient_id}_virus_{index}.jpeg     # Viral pneumonia
        test/
            NORMAL/
                *.jpeg
            PNEUMONIA/
                person{patient_id}_bacteria_{index}.jpeg
                person{patient_id}_virus_{index}.jpeg
    
    Labels:
        NORMAL: 0
        BACTERIA: 1  # Bacterial pneumonia
        VIRUS: 2    # Viral pneumonia
    """
    ...
    def _extract_label(self, image_path: str) -> int:
        ...
        Returns:
            0 for NORMAL, 1 for BACTERIA, 2 for VIRUS
        """
        ...
        if '/NORMAL/' in path_upper:
            ...
            if 'BACTERIA' in filename:
                ...
                raise ValueError(f"Unknown pneumonia type in path: {image_path}")
        else:
...
class ChestXRayMulticlassDataModule(pl.LightningDataModule):
    """LightningDataModule for Chest X-Ray multiclass classification (3 classes).
    ...
    Key features:
        ...
        - Support for 3-class classification
    ...
    def __init__(
        ...
        """Initialize Chest X-Ray Multiclass DataModule.
    ...
    def num_classes(self) -> int:
        """Return the number of classes (multiclass classification)."""
        return 3
    ...
    def setup(self, stage: str = None):
        ...
        self.train_dataset = ChestXRayMulticlassDataset(
            root_dir=train_dir,
            filenames=train_filenames,
            transform=self.train_transform,
        )
        
        self.val_dataset = ChestXRayMulticlassDataset(
            root_dir=train_dir,
            filenames=val_filenames,
            transform=self.val_transform,
        )
        
        self.test_dataset = ChestXRayMulticlassDataset(
            root_dir=test_dir,
    ...
    def _extract_patient_id(self, filename: str) -> str:
        ...
        or person{patient_id}_virus_{index}.jpeg
...
if __name__ == "__main__":
    ...
    for batch in dm.train_dataloader():
        ...
        print(f"Label distribution: {np.bincount(batch[1].numpy())}")
        break